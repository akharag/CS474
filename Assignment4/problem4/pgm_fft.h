...
void                 pgm_complex_shift(struct pgm_complex *);
void                 pgm_complex_log(struct pgm_complex *);
void                 pgm_complex_exp(struct pgm_complex *);
void                 pgm_complex_hp(struct pgm_complex *);

// Additional pgm_image functions
void                 pgm_image_shift(struct pgm_image *);

// Additional functions

double               high_pass(unsigned int, unsigned int);
